"""
Django settings for SiteAnalysisChatbot project.
...
SECRET_KEY = "django-insecure-rn$f3g)2cnt(&mq3^^tvsat03!2x-zi)$&@dpp%^^-6trwq07="
...
WSGI_APPLICATION = "SiteAnalysisChatbot.wsgi.application"
